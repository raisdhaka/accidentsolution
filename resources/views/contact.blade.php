...
<head>
    ...
    <!-- Site Meta Data -->
    <title>Contact Us - Accident Solution</title>
    <meta name="description" content="Contact Accident Solution. Fill in the form below to contact us.							">
    <meta name="keywords" content=",">
    <meta name="robots" content="index, follow">

    <!-- Social Media Meta Data -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="http://www.accidentsolutionllc.com/about/contact">
    <meta property="og:site_name" content="Accident Solution">
    <meta property="og:title" content="Contact Us - Accident Solution">
    <meta property="og:description" content="Contact accident solution. Fill in the form below to contact us.">
    <meta property="og:image" content="http://www.accidentsolutionllc.com/images/Depositphotos_145393015_XL.jpg">
    ...
    <link rel="canonical" href="http://www.accidentsolutionllc.com/about/contact">

	<!-- Google Fonts -->
	<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
	<link rel="stylesheet" media="print" onload="this.onload=null;this.removeAttribute('media');" href="https://fonts.googleapis.com/css?family=Lato:300,400,600,700,800,900|Ubuntu:300,400,600,700,800,900|Open+Sans:300,400,600,700,800,900&display=swap">
	<noscript>
		<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Lato:300,400,600,700,800,900|Ubuntu:300,400,600,700,800,900|Open+Sans:300,400,600,700,800,900&display=swap">
	</noscript>

	<!-- Prefetch -->
	<link rel="prefetch" href="https://www.optimizecdn.com/directory/cdn/assets/bootstrap/font-awesome/fonts/fontawesome-webfont.woff2?v=4.7.0" as="font" type="font/woff2" crossorigin>
	...
	<link rel="stylesheet" media="print" onload="this.onload=null;this.removeAttribute('media');" href="https://www.optimizecdn.com/directory/cdn/assets/bootstrap/css/non-critical-styles.pkgd.min.css">
	<noscript>
		<link rel="stylesheet" href="https://www.optimizecdn.com/directory/cdn/assets/bootstrap/css/non-critical-styles.pkgd.min.css">
	</noscript>

	<!-- Critical Stylesheet -->
	<link rel="stylesheet" href="https://www.optimizecdn.com/directory/cdn/assets/bootstrap/css/critical-styles.pkgd.min.css?v=04.12.23.00">
	...
	<!-- Preload -->
	<link rel="preload" href="https://www.optimizecdn.com/directory/cdn/assets/bootstrap/font-awesome/css/font-awesome.min.css" as="style">
	<link rel="preload" href="/images/sebastian-pichler-bAQH53VquTc-unsplash.jpg" as="image">
	    	<script>
	function g(){
    ...
    <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&region=US&callback=g&language=en"></script>
...
<style>
    ...
    #first_container span.input-group-addon,#first_container .datepicker *,#first_container .input-group-addon, #first_container .input-group-addon * {
    ...
    #myCarousel .list-group-item {
        ...
        border-color: rgba(52, 73, 94,0.80);
    }
    ...
    .pic .pic-caption {
            background: linear-gradient(0deg, rgba(0, 0, 0, 0) 0%,rgba(52, 73, 94,0.85) 50%);
        color: rgb(255, 255, 255);
    }
    .slick-prev-fa i, .slick-next-fa i{
        color: rgb(52, 73, 94);
    }
    .module, .well, .tab-content, .nav-tabs>li.active>a, .nav-tabs>li.active>a:focus, .nav-tabs>li.active>a:hover, .nav-tabs>li>a:focus, .nav-tabs>li>a:hover, .nav-tabs.nav-justified>li.active>a, .nav-tabs.nav-justified>li.active>a:focus, .nav-tabs.nav-justified>li.active>a:hover, .nav-tab.nav-justified>li>a:focus, .nav-tabs.nav-justified>li>a:hover, .account-form-box,.account-form-box .module .module,.account-form-box .module .well,.account-form-box .well .well,.account-form-box .well .module,.module .module .module,.module .well .well,.module .module .well,.module .well .module,.well .well .well,.well .module .module,.well .well .module,.well .module .well {
    ...
    /* Default Colors */
    .btn-primary, .btn-primary.disabled, .btn-primary.disabled.active, .btn-primary.disabled.focus, .btn-primary.disabled:active, .btn-primary.disabled:focus, .btn-primary.disabled:hover, .btn-primary[disabled], .btn-primary[disabled].active, .btn-primary[disabled].focus, .btn-primary[disabled]:active, .btn-primary[disabled]:focus, .btn-primary[disabled]:hover, fieldset[disabled] .btn-primary, fieldset[disabled] .btn-primary.active, fieldset[disabled] .btn-primary.focus, fieldset[disabled] .btn-primary:active, fieldset[disabled] .btn-primary:focus, fieldset[disabled] .btn-primary:hover, .btn.dropdown-toggle.btn-primary {
    ...
    .btn-default, .tags a, .btn-default.disabled, .btn-default.disabled.active, .btn-default.disabled.focus, .btn-default.disabled:active, .btn-default.disabled:focus, .btn-default.disabled:hover, .btn-default[disabled], .btn-default[disabled].active, .btn-default[disabled].focus, .btn-default[disabled]:active, .btn-default[disabled]:focus, .btn-default[disabled]:hover, fieldset[disabled] .btn-default, fieldset[disabled] .btn-default.active, fieldset[disabled] .btn-default.focus, fieldset[disabled] .btn-default:active, fieldset[disabled] .btn-default:focus, fieldset[disabled] .btn-default:hover, .btn.dropdown-toggle.btn-default, #popover .mini_profile_pic {
    ...
    .btn-secondary, .btn.dropdown-toggle.btn-secondary {
    ...
    .homepage-about-module .module{
        ...
        .btn:not(#refcode_submit):not(.input-group-btn .btn):not(.logo-preview-input):not(.cover-preview-input):not(.member_login):not(.img-circle):not(.submit_reply):not(.submit_comment):not(.view-more):not(.image-preview-input):not(.no-radius-bottom):not(.no-radius-top):not(.btn-facebook), .btn-sm:not(.img-circle):not(.view-more):not(.image-preview-input):not(.no-radius-bottom):not(.no-radius-top), .btn-xs:not(.img-circle):not(.view-more):not(.image-preview-input):not(.no-radius-bottom):not(.no-radius-top), button:not(#refcode_submit):not(.input-group-btn button), .btn-group-lg > .btn, .btn-lg, .btn-lg, .btn-xl, .input-group-sm > .input-group-btn > .btn, .favorite, .tags a {
            border-radius: 0px!important;
        }

        .write_comment_container, .tab-content, .well:not(.well .well):not(.module .well):not(.tab-content .well):not(.well.make-connection), .module:not(.module .module):not(.well .module):not(.tab-content .module):not(.search_box .module):not(.posted-by-snippet), .panel, .pic {
...
<!--GOOGLE TAG MANAGER CODE--><div class="header">
			...
			<a href="http://www.accidentsolutionllc.com" title="Accident Solution">
			<img width="450" height="70" src="/images/Accident-Solutions-Can-Help-2.png" alt="Accident Solution">
		</a>
...
.input-group-sm .input-group-addon .fa {
    font-size: 15px;
            ...
            <li class='bmargin xs-nomargin'><span id='link249'  class='bmargin'> 888-852-9911</span></li><li class='bmargin xs-nomargin'><a href='/about/contact' id='link250'  class='hpad bmargin'>Contact Us</a></li><li class='bmargin xs-nomargin'><a href='/login' id='link251'  class='rpad bmargin'>Member Login</a></li><li class='bmargin norpad xs-nopad xs-vmargin'><a href='/join' id='link252'  class='btn btn_get_listed bold'> - Get Listed Today</a></li>        </ul>
            <div class="clearfix"></div>
                <form action="/search_results" name="frm1" class="form-inline website-search">
                        ...
                        <input type="text"
                               placeholder="Category" value="" name="q"
...
.mobile-main-menu .sidebar-nav li a i, .mobile-main-menu .sidebar-nav li span i {
	...
	<li class=''><a href='/home' id='link325'>Home</a></li><li class=''><a href='/about' id='link327'>About Us</a></li><li class=''><a href='/howitworks' id='link335'>How it Works</a></li><li class=''><a href='/personalinjuryattorney' id='link332'>Personal Injury Attorneys</a><ul><li class=''><span id='link358'> Auto Accident</span></li><li class=''><span id='link359'> Amusement Park Accidents</span></li><li class=''><span id='link360'> Aviation Accidents</span></li><li class=''><span id='link361'> Bus Accident</span></li><li class=''><span id='link362'> Bicycle Car Accidents</span></li><li class=''><span id='link363'> Dog Bite </span></li><li class=''><span id='link364'> Motorcycle Accidents</span></li><li class=''><span id='link365'> Pedestrian</span></li><li class=''><span id='link366'> Plane</span></li><li class=''><span id='link367'> Pool Accident</span></li><li class=''><span id='link368'> Product Liability</span></li><li class=''><span id='link369'> Railroad Accidents</span></li><li class=''><span id='link380'> School bus accidents </span></li><li class=''><span id='link370'> Slip and Fall</span></li><li class=''><span id='link371'> Train Accident</span></li><li class=''><span id='link372'> Truck Accident</span></li></ul></li><li class=''><a href='/workerscomp' id='link383'>Worker's Comp</a><ul><li class=''><span id='link374'> Back injuries </span></li><li class=''><span id='link375'> Brain injuries </span></li><li class=''><span id='link376'> Carpal tunnel syndrome</span></li><li class=''><span id='link377'> Construction accident </span></li><li class=''><span id='link378'> Neck injuries </span></li><li class=''><span id='link379'> Slip and fall</span></li><li class=''><span id='link381'> Work-related injuries</span></li><li class=''><span id='link382'> Other</span></li></ul></li><li class=''><a href='/search_results' id='link328'>Directory</a></li><li class=''><a href='/faq' id='link331'>FAQ</a></li><li class=''><a href='/join' id='link329'>Join Today</a></li><li class=''><a href='/about/contact' id='link336'>Contact Us</a></li>	</ul>
</div>
...
<style>
        ...
        background-image: url("/images/sebastian-pichler-bAQH53VquTc-unsplash.jpg");
    ...
    <div class="hero_section_container">
        <div class="container">
            <div class="col-md-8 center-block">
                <h2 class='hero_h2'>Contact Accident Solution by submitting the form below and you will receive a response within 24 hours.</h2>                <div class="clearfix"></div>
            </div>
        </div>
        <div class="clearfix"></div>
    </div>
    ...
    <div class="container">
        ...
        <div class="col-md-12">
                <p><br></p><table class="froala-table" style="width: 100%;"><tbody><tr><td class="fpad-xl" style="width: 50%; vertical-align: top; background-color: rgb(235, 239, 243);"><h2 style="text-align: center;"><strong>Fill In The Form to Contact Us</strong></h2><p><br></p><style type="text/css">label span.required { color: #B94A48; }span.help-inline, span.help-block {font-size: .9em; }</style><form action="/api/widget/json/post/Bootstrap%20Theme%20-%20Function%20-%20Save%20Form" id="contact_form_bootstrap" method="post" labelwidth="100" labelpaddingtop="0.5em" enctype="multipart/form-data" form_action_type="widget" form_action_div="" return_data_type="" name="contact_form" class=" "><input type="hidden" name="sized" value="0" id="contact_form_bootstrap-element-0"/><input type="hidden" name="form" value="myform" id="contact_form_bootstrap-element-1"/><input type="hidden" name="formname" value="contact_form" id="contact_form_bootstrap-element-2"/><input type="hidden" name="dowiz" value="1" id="contact_form_bootstrap-element-3"/><input type="hidden" name="save" value="1" id="contact_form_bootstrap-element-4"/><div class="form-group"><label class="vertical-label bd-text" for="contact_form_bootstrap-element-5"><span class="required">* </span>Name</label><input type="text" name="yourname" required placeholder="Name" autocomplete="off" value class="form-control" id="contact_form_bootstrap-element-5"/></div><div class="form-group"><label class="vertical-label bd-email" for="contact_form_bootstrap-element-6"><span class="required">* </span>Email</label><input type="email" name="inquiry_email" required placeholder="Email" autocomplete="off" value class="form-control" id="contact_form_bootstrap-element-6"/></div><div class="form-group"><label class="vertical-label bd-tel" for="contact_form_bootstrap-element-7"><span class="required">* </span>Phone Number</label><input type="tel" name="phone" required placeholder="Phone Number" autocomplete="off" value class="form-control" id="contact_form_bootstrap-element-7"/></div><div class="form-group"><label class="vertical-label bd-" for="contact_form_bootstrap-element-8">How did you hear about us?</label><textarea rows="4" name="how_did_you_hear_ab" autocomplete="off" class="form-control " id="contact_form_bootstrap-element-8"></textarea></div><div class="form-group"><label class="vertical-label bd-" for="contact_form_bootstrap-element-9">What is the area of service you are interested in?</label><textarea rows="4" name="what_is_the_area_of" autocomplete="off" class="form-control " id="contact_form_bootstrap-element-9"></textarea></div><div class="form-group"><label class="vertical-label bd-" for="contact_form_bootstrap-element-10">Comment or Question</label><textarea rows="4" name="comment_or_question" autocomplete="off" class="form-control " id="contact_form_bootstrap-element-10"></textarea></div><div class="form-group"><div class="form-group security_question_label">            <div id="contact_form_bootstrap-captchaContainer" class="control-group">        <div class="g-recaptcha"  id="contact_form_bootstrap-google-recaptcha"></div>    </div>    <small class="help-block" id="recaptcha_error" style="display:none;" data-fv-validator="notEmpty" data-fv-for="recaptcha" data-fv-result="INVALID" />The security check was not completed successfully.</small>    <div class="clearfix bmargin"></div>    <input type="hidden" name="recaptcha" id="contact_form_bootstrap-rcap"></div>    <style>        .modal .g-recaptcha-scale, .col-md-4 .g-recaptcha-scale, .col-md-3 .g-recaptcha-scale, .col-lg-3 .g-recaptcha-scale, .col-lg-4 .g-recaptcha-scale {            transform: scale(0.77);            -webkit-transform: scale(0.77);            transform-origin: 0 0;            -webkit-transform-origin: 0 0;            margin-bottom: -15px;        }        .modal #contact_form_bootstrap-captchaContainer, .col-md-4 #contact_form_bootstrap-captchaContainer, .col-md-3 #contact_form_bootstrap-captchaContainer, .col-lg-3 #contact_form_bootstrap-captchaContainer, .col-lg-4 #contact_form_bootstrap-captchaContainer {            transform: scale(0.77);            -webkit-transform: scale(0.77);            transform-origin: 0 0;            -webkit-transform-origin: 0 0;            margin-bottom: -15px;        }    </style>    <script type="text/javascript">        var formID          = '';        var currentCaptcha  = {};        var captchaHolders  = {};        window.addEventListener('load', () => {            formID = document.querySelectorAll('[name="recaptcha"]');            if (typeof formID != "undefined" && formID !== null) {                for (let i = 0; i < formID.length; i++) {                    let formIDForm = formID[i].closest('form');                    if (typeof formIDForm != "undefined" && formIDForm !== null) {                        formIDForm.addEventListener('click', reCaptchaOnFormClick, false);                    }                }            }        });        function reCaptchaOnFormClick(event) {            currentCaptchaForm  = event.srcElement.closest('form');            var head            = document.getElementsByTagName('head')[0];            var script          = document.createElement('script');            script.type         = 'text/javascript';            script.src          = 'https://www.google.com/recaptcha/api.js?onload=onloadCallback&render=explicit&hl=en';            head.appendChild(script);            if (typeof currentCaptchaForm != "undefined" && currentCaptchaForm !== null) {                currentCaptchaForm.removeEventListener('click', reCaptchaOnFormClick, false);            }        }        var onloadCallback = function (event) {            var captcha = currentCaptchaForm.querySelectorAll('div[class=g-recaptcha]');            if(captcha[0].id){                captchaHolders[captcha[0].id] = grecaptcha.render(captcha[0].id, {                    'sitekey': '6LdVlIEfAAAAALs8F1418WpUFvNZXRlnXghMPaQh'                });            }        }    </script><script>    function respuesta() {        var checkedTextArea = document.getElementsByClassName('g-recaptcha');        var rcap = document.getElementsByTagName('recaptcha');        for (var i = 0; i < checkedTextArea.length; i++) {            if (checkedTextArea[i].value != '') {                for (var index = 0; i < rcap.length; index++) {                    rcap[index].setAttribute("value", "checked");                }            }        }    }    $(document).ready(function(){        $("#contact_form_bootstrap input[type=submit]").unbind('click');        $("#contact_form_bootstrap input[type=submit]").click(function (event) {            var formId = $(this.form).attr('id');            var captchaHolderKey = formId + "-google-recaptcha";            if (typeof captchaHolders[captchaHolderKey] != "undefined") {                event.preventDefault();                if (grecaptcha.getResponse(captchaHolders[captchaHolderKey]) === "") {                    $("#" + formId).formValidation('validate');                    $("#" + formId + " .security_question_label").addClass("has-error");                    $("#" + formId + " #recaptcha_error").css("display", "block");                    return false;                } else {                    $("#" + formId + " .security_question_label").removeClass("has-error");                    $("#" + formId + " #recaptcha_error").css("display", "none");                    respuesta();                    $("#" + formId).submit();                }            }        });    });</script></div><div class="form-group"><input type="hidden" name="bd_hpc" autocomplete="off" value class="form-control " id="contact_form_bootstrap-element-13"/></div><div class="form-actions"><input type="submit" value="Send Message" name class="btn btn-primary btn-lg btn-block " id="contact_form_bootstrap-element-14"/></div></form><script type="text/javascript">jQuery(document).ready(function() {		jQuery("#contact_form_bootstrap").bind("submit", function() { 		});}); </script></td><td class="fpad-xl" style="width: 50%; vertical-align: top;"><h2 style="text-align: center;"><br></h2><ul style="list-style-type: circle;"><li><span style="font-size: 24px;"><br><br></span></li></ul></td></tr></tbody></table><p><br><br><br><br><br></p>        </div>
...
<style type='text/css'> .newsletter_row input[type="email"] {
    ...
    <div class="container">
        <div class="row">
            <ul class="footer_menu sm-text-center">
                <li class='col-md-2 col-md-offset-1'><span id='link338'  class='head'> Website</span><ul><li class=''><a href='/howitworks' id='link339'>How It Works</a></li><li class=''><a href='/join' id='link340'>List Your Company</a></li></ul></li><li class='col-md-2'><span id='link341'  class='head'> Search</span><ul><li class=''><a href='/categories' id='link342'>Browse Categories</a></li><li class=''><a href='/locations' id='link343'>Browse Locations</a></li></ul></li><li class=''><a href='/about/contact' id='link346'>Contact Us</a></li><li class='col-md-2'><span id='link344'  class='head'> Support</span><ul><li class=''><a href='/login' id='link345'>Member Login</a></li><li class='font-sm inline-block hpad'><a href='/about/terms' id='link355'  title='Terms of Use'>Terms of Service</a></li></ul></li><li class='col-md-12 clearfix'><span id='link347'> </span></li><li class='col-md-5 vpad vmargin'><span id='link348'> <div itemscope itemtype="http://schema.org/WebSite">
	...
	<div class="list-social-links">
		<a class="network-icon contact" href="/about/contact" title="Contact Us Accident Solution">
...
</div></span></li><li class='col-md-6 col-md-offset-1 vpad vmargin'><a href='/join' id='link349'  class='btn btn_footer_get_listed btn-lg btn-block bold center sm-block'> - Get Listed Today</a></li><li class='col-md-12 clearfix vmargin text-center'><span id='link350'> </span><ul><li class='clearfix vmargin vpad inline-block'><span id='link351'> </span></li><li class='btn-lg font-sm  novpad  norpad inline-block'><span id='link352'> © 2023</span></li><li class='font-sm inline-block hpad'><a href='/' id='link353'  title='Accident Solution'>Accident Solution</a></li><li class='font-sm inline-block'><span id='link354'> All Rights Reserved</span></li><li class='font-sm inline-block'><a href='/about/privacy' id='link356'  title='Privacy Policy'>Privacy Policy</a></li></ul></li>            </ul>
        </div>
		    </div>
  ...
  left: 10px;
    ...
    <div class="row member-login-page-container">
        <div class="fpad-lg novpad">
                        ...
                        <style type="text/css">label span.required { color: #B94A48; }span.help-inline, span.help-block {font-size: .9em; }</style><form action="/api/widget/json/get/Bootstrap%20Theme%20-%20Member%20Login%20Page" id="member_login" method="post" labelwidth="100" labelpaddingtop="0.5em" enctype="multipart/form-data" form_action_type="redirect" form_action_div return_data_type="" name="member_login" class=" "><input type="hidden" name="sized" value="0" id="member_login-element-0"/><input type="hidden" name="form" value="myform" id="member_login-element-1"/><input type="hidden" name="formname" value="member_login" id="member_login-element-2"/><input type="hidden" name="dowiz" value="1" id="member_login-element-3"/><input type="hidden" name="save" value="1" id="member_login-element-4"/><input type="hidden" name="action" autocomplete="off" value="login" id="member_login-element-5"/><h2 class="nomargin member-login-h2-form-title">Member Login</h2><hr><div class="form-group"><label class="vertical-label bd-email" for="member_login-element-8"><span class="required">* </span>Email Address</label><input type="email" name="email" required placeholder="name@yoursite.com" autocomplete="off" value class="form-control input-lg" id="member_login-element-8"/></div><div class="form-group"><label class="vertical-label bd-password" for="member_login-element-9"><span class="required">* </span>Password</label><input type="password" name="pass" required placeholder="Enter Password" autocomplete="off" value class="form-control input-lg" id="member_login-element-9"/></div><span class="help-block bpad bmargin notmargin">Forgot Password? <a href="/login/retrieval">Click to Reset Password</a></span><div class="form-actions"><input type="submit" value="Login Now" name class="btn btn-primary btn-lg btn-block " id="member_login-element-11"/></div><div class="login-cta-buttons"><hr class="cta-hr"><ul class="list-inline nomargin inline-block btn-block"><li class='col-md-6 nolpad sm-nopad nav'><a href='/checkout/5' id='link197'  class='btn btn-danger btn-block sm-bmargin'>Not a Registered User? <span class="inline-block">Create Free User Account</span></a></li><li class='col-md-6 norpad sm-nopad nav'><a href='/join' id='link198'  class='btn btn-success btn-block'>Are You a Local Business? <span class="inline-block">List Your Company Now</span></a></li></ul><div class="clearfix"></div></div></form><script type="text/javascript">jQuery(document).ready(function() {		jQuery("#member_login").bind("submit", function() {
    ...
    <link rel="stylesheet" media="print" onload="this.onload=null;this.removeAttribute('media');" href="https://www.optimizecdn.com/directory/cdn/assets/bootstrap/limonte-sweetalert2/6.11.2/sweetalert2.min.css">
    <noscript>
        <link rel="stylesheet" href="https://www.optimizecdn.com/directory/cdn/assets/bootstrap/limonte-sweetalert2/6.11.2/sweetalert2.min.css">
    </noscript>
...
<script>
    ...
    $(".website_url_field").keyup(function(){
        ...
        var counterSubmit = 0;
        $(document).ready(function() {
            $('#contact_form_bootstrap').formValidation({"framework":"bootstrap","addOns":{"reCaptcha2":{"element":"captchaContainer","language":"en","theme":"light","siteKey":"6LdVlIEfAAAAALs8F1418WpUFvNZXRlnXghMPaQh","timeout":"120","message":"The captcha is not valid"}},"fields":{"yourname":{"validators":{"notEmpty":{"message":"Required Field"}}},"inquiry_email":{"validators":{"notEmpty":{"message":"Required Field"},"emailAddress":{"message":"Please enter a valid email address"}}},"phone":{"validators":{"notEmpty":{"message":"Required Field"}}}}}).on('success.form.fv', function(e,fvdata) {

                if('contact_form_bootstrap' == 'unsubscribe_email'){
                    return true;
                }
                ...
                if($("#contact_form_bootstrap .location_required").length > 0){
                    $("#contact_form_bootstrap .location_required").each(function (index) {
                        if($(this).data('state') == 1){
                            if($('#contact_form_bootstrap input[name="lead_location"]').val() == "" || $('#contact_form_bootstrap input[name="lat"]').val() == "" || $('#contact_form_bootstrap input[name="lng"]').val() == "") {
                ...
                if ($("#contact_form_bootstrap-notification").html() != "") {
                    $("#contact_form_bootstrap-notification").remove();
                }
                if ($(this).find('input[type="submit"]').length > 0) {
                    $(this).find('input[type="submit"]').before('<div id="contact_form_bootstrap-notification" class="alert"></div>');

                } else {
                    $(this).prepend('<div id="contact_form_bootstrap-notification" class="alert"></div>');
                }
                var notification = $("#contact_form_bootstrap-notification");
                ...
                if ((form_action_type == "" || form_action_type == "default") && action.indexOf("account") >= 0) {
                    ...
                    if(counterSubmit == 0) {
                        ...
                        if($("#contact_form_bootstrap input[type=file]").length > 0){
                            ...
                            $("#contact_form_bootstrap input[type=file]").each(function(index,node){
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (result == "success") {
                                    ...
                                    if (form_action_type == "notification") {
                                        ...
                                        if(notification.parents('.modal').length && 'contact_form_bootstrap' == 'whmcs_billing_address'){
                                            setTimeout(function(){
                                        ...
                                        current_location = "/about/contact";
                                    ...
                                    if(form_action_div != '.newsletter_modal_form_container' && 'contact_form_bootstrap' != 'whmcs_billing_address'){
                                        $('.modal-backdrop').hide();
                                    }
                                } else {
                                    ...
                                    $("#contact_form_bootstrap-notification").html(message)
                            ...
                            error: function (e) {
                                ...
                                if(typeof grecaptcha !== "undefined"){
                                        grecaptcha.reset();
                                        $("#contact_form_bootstrap-notification").html(`Recaptcha Error`);
                                } else {
                                    $("#contact_form_bootstrap-notification").html(`A connection error occurred while saving. Please try to save again.`);
                                }
                                $("#contact_form_bootstrap-notification").addClass("alert-warning")
                                    .removeClass("alert-success")
                                    .removeClass("alert-warning")
                                    .fadeIn();
                                counterSubmit = 0;
            ...
            $('#contact_form_bootstrap select').each(function (i, obj) {
                setTimeout(function(){
        ...
        function googleMapOnFormClick() {
            ...
            let mapUri ="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&region=US&callback=initializeG&language=en";
            if (typeof googleSuggestForm != "undefined") {
                for (let i = 0; i < googleSuggestForm.length; i++) {
                    let closestForm = googleSuggestForm[i].closest('form');
                    if(typeof closestForm != "undefined" && closestForm != null){
        ...
        function initializeG() {
            ...
            if (typeof setJsMapSR !== 'undefined' && typeof setJsMapSR === 'function') {
                setJsMapSR();
            }
            ...
            function populateSearchFields() {
                ...
                if (prePopulateLocationSetting == 1 && (geolocationMethod === "HTML5" || geolocationMethod === "IP") && (vlat !== '' && vlon !== '' && vlat != undefined && vlon != undefined)) {
...
</script></div><div class="form-group"><input type="hidden" name="bd_hpc" autocomplete="off" value class="form-control control-group " id="newsletter-element-10"/></div><div class="form-actions"><input type="submit" value="Subscribe Now" name class="btn btn-success btn-block btn-lg  bold " id="newsletter-element-11"/></div><input type='hidden' name='origin' value='/about/contact'></form><script type="text/javascript">jQuery(document).ready(function() {		jQuery("#newsletter").bind("submit", function() {
		});}); </script>						</div>
						<br>
					</div>
				</div>
